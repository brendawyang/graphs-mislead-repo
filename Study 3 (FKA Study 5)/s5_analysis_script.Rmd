...
Data was collected using qualtrics between October 23 and November 25th, 2018 using Amazon's Mechanical Turk for distribution and Qualtrics as a survey platform. 
...
You can exclude subjects who did not get the correct answer in the exercise by changing Exclude_Exercise_Check (line 102) to TRUE. The next time you run all the code, these participants will be excluded. 
